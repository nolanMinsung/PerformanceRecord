...
final class ORBRecommendationGradientLayer: CAGradientLayer {
    ...
    private let color1: CGColor = UIColor.init(hexLight: "62DDFF").cgColor // 하늘색
    private let color2: CGColor = UIColor.init(hexLight: "455BFF").cgColor // 파란색
    private let color3: CGColor = UIColor.init(hexLight: "CC01FF").cgColor // 보라색
    private let color4: CGColor = UIColor.init(hexLight: "FF007B").cgColor // 자주색
